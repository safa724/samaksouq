...
class _HomeState extends State<Home> {
  ...
  String selectedLocationName = ''; // Default location name
  String selectedLocationId = '4125'; // Default location id
  bool isLocationSelected = false; // Initialize isLocat
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // Assuming locations are returned in responseData['location']
      List<Map<String, dynamic>> locations = List<Map<String, dynamic>>.from(responseData['location']);
...
void selectLocation(Map<String, dynamic> selectedLocation) {
  if (selectedLocation != null) {
    setState(() {
      selectedLocationId = selectedLocation['id'].toString(); // Convert to String
...
Future<void> fetchTodayDeallimProducts(String locationId) async {
    ...
    try {
      final http.Response todayDeallimProductsResponse =
          await http.get(Uri.parse(todayDeallimProductsUrl), headers: {'Content-Type': 'application/json'});
      ...
      if (todayDeallimProductsResponse.statusCode == 200) {
        ...
        print('Error fetching today deal products - Status Code: ${todayDeallimProductsResponse.statusCode}');
    ...
    return WillPopScope(
              ...
              flexibleSpace: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color.fromARGB(255, 2, 67, 119), Colors.white], // Add your gradient colors
      ...
      selectLocation(selectedLocation);
        ...
        children: [
          ...
          SizedBox(width: 5),
          Text(selectedLocationName, style: TextStyle(fontSize: 12,color: Colors.white),),
          Icon(Icons.arrow_right_sharp,color: Colors.white,size: 14,),
        ],
      ),
      ),
              ...
              // Add the search box with rounded corners
                        ...
                        Expanded(
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              hintText: 'Search for products',hintStyle: TextStyle(fontFamily: 'Montserrat'),
                            ),
                          ),
                        ),
        ...
        body: isLoading
            ? Center(
                child: CircularProgressIndicator(
                  valueColor:
                      AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 2, 67, 119)),
                ),
              )
            : Padding(
      ...
      viewportFraction: 1.0, // Set to 1.0 to occupy the entire viewport
        ),
                      ...
                      Row(
                        ...
                        children: List.generate(
                          ...
                          (index) => Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  _currentIndex == index ? Color.fromARGB(255, 4, 79, 141) : Colors.grey,
      ...
      children: [
        ...
        Spacer(), // This widget will push 'View All' and the icon to the right side
        ...
        context,
        MaterialPageRoute(
      builder: (context) =>TodayDeal(locationId: selectedLocationId)
       
        ),
      );
          },
          icon: Icon(Icons.arrow_circle_right_sharp,color: Colors.green,),
        ),
      ],
        ),
      ),
      ...
      children: todayDeallimProducts.map((product) {
        ...
        return SizedBox(
          width: 150,
          child: ProductCard(product: product, products: todayDeallimProducts),
        );
      }).toList(),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        height: 200, // Adjust the overall height of the ProductCard
        decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: <Widget>[
           ...
           Padding(
            ...
            // Name and Main Price Centered
            Container(
              padding: EdgeInsets.symmetric(vertical: 8, horizontal: 8),
              height: 80, // Adjust the height of the grey rectangle
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.only(
